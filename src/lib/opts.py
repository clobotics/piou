  ...
  def __init__(self):
    ...
    self.parser.add_argument('--not_rand_crop', action='store_true',
                             help='not use the random crop data augmentation'
                                  'from CornerNet.')
    self.parser.add_argument('--not_clip', action='store_true',
                             help='not use the clip data augmentation'
                                  'from CornerNet.')
    ...
    self.parser.add_argument('--piou_weight', type=float, default=-1,
                             help='loss weight for bounding box size.')
    # ctdet_angle
    self.parser.add_argument('--angle_weight', type=float, default=1,
                             help='loss weight for rotation bounding box angle.')
    # multi_pose
  ...
  def init(self, args=''):
    default_dataset_info = {
      ...
      'exdet': {'default_resolution': [512, 512], 'num_classes': 80,
                'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                'dataset': 'coco'},
      'ctdet_angle': {'default_resolution': [512, 512], 'num_classes': 16,
                      'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
                      'dataset': 'dota'},
      # 'ctdet_angle': {'default_resolution': [512, 512], 'num_classes': 1,
      #                 'mean': [0.408, 0.447, 0.470], 'std': [0.289, 0.274, 0.278],
      #                 'dataset': 'retail50k'},
      'multi_pose': {
